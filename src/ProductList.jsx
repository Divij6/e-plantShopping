  ...
  const plantsArray = [
    ...
    },
    {
      ...
      plants: [
        ...
        { name: "Citronella", image: "https://cdn.pixabay.com/photo/2015/07/02/21/55/cat-829681_1280.jpg", description: "Famous natural mosquito repellent plant.", cost: "$13" },
    ...
    },
    {
      ...
      plants: [
        ...
        { name: "Turmeric", image: "https://cdn.pixabay.com/photo/2018/04/02/07/42/leaf-3283175_1280.jpg", description: "Anti-inflammatory and antioxidant properties.", cost: "$18" },
        { name: "Ginger", image: "https://cdn.pixabay.com/photo/2016/08/19/19/48/flowers-1606041_1280.jpg", description: "Aids digestion and relieves nausea.", cost: "$14" }
      ]
    },
    {
      ...
      plants: [
        ...
        { name: "Dracaena", image: "https://cdn.pixabay.com/photo/2021/01/22/06/04/snake-plant-5939187_1280.jpg", description: "Easy to grow and maintain, great for beginners.", cost: "$19" }
      ]
    }
  ];
          ...
          <div>
            <a href="#" onClick={(e) => handleCartClick(e)} style={styleA}>
              <div className="cart" style={{ position: 'relative', display: 'inline-block' }}>
                ...
                <span className="cart_quantity_count" style={{ position: 'absolute', top: '8px', right: '-8px', backgroundColor: 'red', borderRadius: '50%', padding: '2px 7px', fontSize: '16px', fontWeight: 'bold' }}>
                  {getTotalCartItems()}
                </span>
              </div>
            </a>
